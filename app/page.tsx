 ...
 return <main id="top"><div className="page-progress" aria-hidden="true"/>
  ...
  <section className="scroll-story" aria-label="From complexity to production">
   <div className={`hero-scene story-sticky ${assembled?'assembled':''}`}>
    ...
    <div className="hero-bottom"><a href="#approach" className="story-skip">EXPLORE OUR APPROACH <ArrowUpRight size={16}/></a><button className="assemble-button" onClick={()=>setAssembled(!assembled)} aria-pressed={assembled}>{assembled?'RELEASE THE SYSTEM':'CONNECT THE SYSTEM'}<Plus size={18} className={assembled?'rotated':''}/></button></div>
