...
const bubbleVariants = cva(
  [
    'gap-1 data-[align=end]:self-end max-w-[80%]',
    'data-[variant=ghost]:max-w-full group-data-[align=end]/message:self-end',
    ...
    props: mergeProps<'div'>(
      {
        className: cn(
          [
            ...
            'group-data-[align=end]/bubble:self-end w-fit max-w-full min-w-0',
            'overflow-hidden wrap-break-word [button]:text-left',
...
const bubbleReactionsVariants = cva(
  [
    'rounded-full ring-3 ring-card bg-muted shrink-0 gap-1 px-1.5 py-0.5',
    'has-[button]:p-0 text-sm absolute z-10 flex w-fit items-center',
    'justify-center',
  ].join(' '),
  {
    variants: {
