    ...
    <DrawerPrimitive.Backdrop
      ...
      className={cn(
        [
          ...
          'select-none data-ending-style:pointer-events-none',
    ...
    <div
      ...
      className={cn(
        [
          ...
          'group-data-[swipe-direction=right]/drawer-popup:justify-end relative',
          'z-10 flex shrink-0 cursor-grab transition-opacity duration-200',
        ...
        <DrawerPrimitive.Popup
          ...
          className={cn(
            ...
            [
              ...
              'data-[swipe-direction=up]:border-b group/drawer-popup',
              'pointer-events-auto fixed z-50 m-(--drawer-inset,0px) flex',
              'h-(--drawer-content-height) max-h-(--drawer-content-max-height,none)',
              'min-h-0 w-(--drawer-content-width,auto)',
              'transform-[translate3d(var(--translate-x,0px),var(--translate-y,0px),0)_scale(var(--stack-scale))]',
              'flex-col transition-[transform,height,opacity,filter] duration-450',
              'ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform outline-none',
              'select-none [interpolate-size:allow-keywords]',
            ].join(' '),
            // Nested.
            ...
            [
              ...
              'data-[swipe-axis=x]:after:inset-y-0',
              'data-[swipe-axis=x]:after:w-(--bleed)',
              'data-[swipe-axis=y]:after:inset-x-0',
              'data-[swipe-axis=y]:after:h-(--bleed)',
            ...
            [
              ...
              'data-[swipe-direction=down]:origin-bottom',
            ...
            [
              ...
              'data-[swipe-direction=left]:origin-left',
            ...
            [
              ...
              'data-[swipe-direction=right]:origin-right',
          ...
          <DrawerPrimitive.Content
            ...
            className={cn(
              [
                ...
                'ease-[cubic-bezier(0.45,1.005,0,1.005)] select-text',
                'group-data-nested-drawer-open/drawer-popup:opacity-0',
                'group-data-nested-drawer-swiping/drawer-popup:opacity-100',
...
function DrawerHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        [
          'gap-0.5 p-4 pb-0 md:gap-0.5 md:text-left flex shrink-0 flex-col',
