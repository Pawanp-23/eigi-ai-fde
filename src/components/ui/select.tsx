        ...
        <SelectPrimitive.Popup
          ...
          className={cn(
            [
              ...
              'min-w-36 origin-(--transform-origin) overflow-x-hidden overflow-y-auto',
              'rounded-lg bg-popover text-popover-foreground shadow-md ring-1',
              'ring-foreground/10 duration-100 data-[align-trigger=true]:animate-none',
    ...
    <SelectPrimitive.Item
      ...
      className={cn(
        [
          ...
          'pr-8 pl-1.5 text-sm outline-hidden select-none focus:bg-accent',
