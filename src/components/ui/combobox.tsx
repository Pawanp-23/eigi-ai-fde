        ...
        <ComboboxPrimitive.Popup
          ...
          className={cn(
            [
              ...
              '*:data-[slot=input-group]:border-input/30 overflow-hidden rounded-lg',
              'shadow-md ring-1 duration-100 *:data-[slot=input-group]:m-1',
              ...
              'cn-menu-translucent group/combobox-content relative',
              'max-h-(--available-height) w-(--anchor-width) max-w-(--available-width)',
              'min-w-[calc(var(--anchor-width)+--spacing(7))]',
              'origin-(--transform-origin) data-[chips=true]:min-w-(--anchor-width)',
            ].join(' '),
            className,
          )}
          {...props}
    ...
    <ComboboxPrimitive.Item
      ...
      className={cn(
        [
          ...
          'gap-2 rounded-md py-1 pr-8 pl-1.5 text-sm',
          "[&_svg:not([class*='size-'])]:size-4 relative flex w-full cursor-default",
    ...
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        [
          ...
          'focus-within:ring-ring/50 has-aria-invalid:ring-destructive/20',
          'dark:has-aria-invalid:ring-destructive/40',
          'has-aria-invalid:border-destructive',
          'dark:has-aria-invalid:border-destructive/50 flex min-h-8 flex-wrap',
    ...
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        [
          ...
          'whitespace-nowrap has-data-[slot=combobox-chip-remove]:pr-0',
