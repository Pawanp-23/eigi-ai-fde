      ...
      <AlertDialogPrimitive.Popup
        ...
        className={cn(
          [
            ...
            'bg-popover text-popover-foreground ring-foreground/10 gap-4 rounded-xl',
            'p-4 ring-1 duration-100 data-[size=default]:max-w-xs',
...
function AlertDialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        [
          'bg-muted/50 -mx-4 -mb-4 rounded-b-xl border-t p-4 flex flex-col-reverse',
          'gap-2 group-data-[size=sm]/alert-dialog-content:grid',
