...
const toggleVariants = cva(
  [
    'hover:text-foreground aria-pressed:bg-muted focus-visible:border-ring',
    'focus-visible:ring-ring/50 aria-invalid:ring-destructive/20',
    'dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive',
    'data-[state=on]:bg-muted gap-1 rounded-lg text-sm font-medium',
    "transition-all [&_svg:not([class*='size-'])]:size-4 group/toggle",
    'inline-flex items-center justify-center whitespace-nowrap outline-none',
    'hover:bg-muted focus-visible:ring-[3px] disabled:pointer-events-none',
