    ...
    <div
      ...
      className={cn(
        [
          ...
          'has-disabled:bg-input/50 dark:has-disabled:bg-input/80 h-8 rounded-lg',
          ...
          'has-[>[data-align=inline-start]]:[&>input]:pl-1.5 group/input-group',
...
const inputGroupAddonVariants = cva(
  [
    'text-muted-foreground h-auto gap-2 py-1.5 text-sm font-medium',
    'group-data-[disabled=true]/input-group:opacity-50',
    '[&>kbd]:rounded-[calc(var(--radius)-5px)]',
    "[&>svg:not([class*='size-'])]:size-4 flex cursor-text items-center",
    ...
    <Input
      ...
      className={cn(
        [
          ...
          'dark:bg-transparent dark:disabled:bg-transparent flex-1',
        ].join(' '),
        className,
      )}
      {...props}
...
function InputGroupTextarea({
  ...
  return (
    <Textarea
      ...
      className={cn(
        [
          'rounded-none border-0 bg-transparent py-2 shadow-none ring-0',
          'focus-visible:ring-0 disabled:bg-transparent aria-invalid:ring-0',
          'dark:bg-transparent dark:disabled:bg-transparent flex-1 resize-none',
        ].join(' '),
        className,
      )}
      {...props}
