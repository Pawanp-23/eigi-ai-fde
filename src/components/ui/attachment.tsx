...
const attachmentVariants = cva(
  [
    'rounded-xl w-fit focus-within:ring-1 focus-within:ring-ring/50',
    'group/attachment relative flex max-w-full min-w-0 shrink-0 flex-wrap',
...
const attachmentMediaVariants = cva(
  [
    ...
    'overflow-hidden group-data-[state=error]/attachment:bg-destructive/10',
  ...
  ].join(' '),
  {
    variants: {
      variant: {
        icon: '',
        image: [
          'opacity-60 group-data-[state=idle]/attachment:opacity-100',
          'group-data-[state=done]/attachment:opacity-100 *:[img]:aspect-square',
...
function AttachmentTitle({
  ...
  return (
    <span
      ...
      className={cn(
        [
          'font-medium block max-w-full min-w-0 truncate',
...
function AttachmentDescription({
  ...
  return (
    <span
      ...
      className={cn(
        [
          'mt-0.5 text-xs block min-w-0 truncate text-muted-foreground',
    ...
    <div
      ...
      className={cn(
        [
          ...
          'group-data-[orientation=vertical]/attachment:right-3 relative z-20',
          'group-data-[orientation=vertical]/attachment:gap-1 flex shrink-0',
          'items-center',
        ].join(' '),
        className,
      )}
...
function AttachmentGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        [
          'gap-3 scroll-px-1 py-1 flex min-w-0 scroll-fade-x snap-x snap-mandatory',
