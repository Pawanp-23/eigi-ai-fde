        ...
        <MenuPrimitive.Popup
          ...
          className={cn(
            [
              ...
              'bg-popover p-1 text-popover-foreground shadow-md ring-1',
    ...
    <MenuPrimitive.SubmenuTrigger
      ...
      className={cn(
        [
          ...
          'not-data-[variant=destructive]:focus:**:text-accent-foreground',
          'data-inset:pl-7 data-popup-open:bg-accent',
          'data-popup-open:text-accent-foreground data-open:bg-accent',
          'data-open:text-accent-foreground [&_svg]:pointer-events-none',
