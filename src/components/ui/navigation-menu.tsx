...
const navigationMenuTriggerStyle = cva(
  [
    'hover:bg-muted focus:bg-muted data-open:hover:bg-muted',
    'data-open:focus:bg-muted data-open:bg-muted/50',
    'focus-visible:ring-ring/50 data-popup-open:bg-muted/50',
    'data-popup-open:hover:bg-muted rounded-lg px-2.5 py-1.5 text-sm',
    'font-medium transition-all focus-visible:ring-3 focus-visible:outline-1',
    'disabled:opacity-50 group/navigation-menu-trigger inline-flex h-9 w-max',
    'items-center justify-center outline-none disabled:pointer-events-none',
  ].join(' '),
);
    ...
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        [
          ...
          'group-data-[viewport=false]/navigation-menu:ring-foreground/10 p-1',
          ...
          'h-full w-auto transition-[opacity,transform,translate] duration-[0.35s]',
  ...
  return (
    <NavigationMenuPrimitive.Portal>
      <NavigationMenuPrimitive.Positioner
        ...
        className={cn(
          [
            'ease-[cubic-bezier(0.22,1,0.36,1)] data-[side=bottom]:before:top-[-10px]',
            ...
            'duration-[0.35s] data-instant:transition-none',
          ].join(' '),
          className,
        )}
        {...props}
      >
        <NavigationMenuPrimitive.Popup
          className={[
            'bg-popover text-popover-foreground ring-foreground/10 rounded-lg shadow',
            'ring-1 outline-none data-ending-style:scale-90',
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        [
          'data-active:focus:bg-muted data-active:hover:bg-muted',
          'data-active:bg-muted/50 focus-visible:ring-ring/50 hover:bg-muted',
          'focus:bg-muted flex items-center gap-2 rounded-lg p-2 text-sm',
          'transition-all outline-none focus-visible:ring-3 focus-visible:outline-1',
