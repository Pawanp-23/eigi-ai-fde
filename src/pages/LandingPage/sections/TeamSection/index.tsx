...
const disciplines = [
  ...
  },
  {
    ...
    role: 'From working prototype to daily use',
  },
];
  ...
  return (
    ...
    >
      <div className="eigi-team-portrait">
        {failed ? (
          <div
            className="eigi-portrait-fallback"
            aria-hidden="true"
          >
            <UsersRound size={64} />
          </div>
        ...
        <span className="eigi-portrait-label">
...
export default function EigiTeam({ paused = false }: { paused?: boolean }) {
  ...
  return (
    <section
      id="eigi-team"
      className="eigi-team-section"
      aria-labelledby="eigi-team-heading"
    >
      <svg
        className="eigi-team-scribble"
        aria-hidden="true"
        fill="none"
        viewBox="0 0 460 154"
      >
